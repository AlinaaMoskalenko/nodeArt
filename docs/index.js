...
var _renderCard = __webpack_require__(331);

var _feedbackForm = __webpack_require__(334);
...
var _slide3 = __webpack_require__(336);
...

{
  ...
  new _feedbackForm2.default(feedbackFormContainer, feedbackLink, gridContainer);
}

{
  // slider block
  var slider = document.getElementById('slider');
  var cardArray = [_slide2.default, _slide4.default];

  new _slider2.default(slider, cardArray);
}

{
  ...
  for (var i = 0; i < 5; i++) {
    cardContainer.appendChild((0, _renderCard.renderCard)(i));
  }
}
...
var Slider = function () {
  function Slider(rootElement, elements) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      try {
        for (var _iterator = this.elements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var classes = id === 0 ? ['slider__photo', 'slider__photo_shown'] : ['slider__photo'];
          (_img$classList = this.img.classList).add.apply(_img$classList, classes);
      ...
      try {
        for (var _iterator2 = this.toggles[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var toggle = _step2.value;

          toggle.addEventListener('click', function (_ref) {
            var idx = _ref.target.id;
            return _this.onToggle(idx);
          });
        }
      } catch (err) {
    ...
    key: 'onToggle',
    value: function onToggle(idx) {
      var _this2 = this;

      clearInterval(this.timer);
      clearTimeout(this.timeOutTimer);

      var value = idx === 'left' ? -1 : 1;
      var nextSlide = this.currentSlide + value;
      ...
      this.timeOutTimer = setTimeout(function () {
        return _this2.autoPlay(nextSlide + 1, _this2.slides);
      }, 2000);
    }
  }, {
    key: 'autoPlay',
    value: function autoPlay(slideId, slides) {
      var _this3 = this;

      var idx = slideId !== slides.length ? slideId : 0;

      this.timer = setInterval(function () {
        var currentSlide = idx === 0 ? slides.length - 1 : idx - 1;
        var nextSlide = idx === slides.length ? 0 : idx;
        _this3.isSlide(currentSlide, nextSlide, slides);
    ...
    key: 'isSlide',
    value: function isSlide(currentId, nextId, slides) {
...
exports.renderCard = undefined;

var _nophoto = __webpack_require__(332);

var _nophoto2 = _interopRequireDefault(_nophoto);

var _addtobasket_mini = __webpack_require__(333);

var _addtobasket_mini2 = _interopRequireDefault(_addtobasket_mini);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var renderCard = exports.renderCard = function renderCard(id) {
  var itemPhoto = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _nophoto2.default;
  var itemTitle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'Самый клевый чайник, который надо купить!';
  var itemPrice = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '1 900 p.';
  ...
  var buyingBlock = document.createElement('div');
  ...
  basket.setAttribute('src', _addtobasket_mini2.default);
...
module.exports = "./assets/images/nophoto.png";

/***/ }),
/* 333 */
/***/ (function(module, exports) {

module.exports = "./assets/images/addtobasket_mini.png";
...
var FeedbackForm = function () {
  function FeedbackForm(rootElement, openLink, siteContainer) {
  ...
  _createClass(FeedbackForm, [{
    ...
    value: function render() {
      ...
      this.openLink.addEventListener('click', function () {
        _this.siteContainer.classList.add('grid-container_hidden');
        _this.rootElement.classList.add('grid-item-7_shown');
      });

      this.closeBtn.addEventListener('click', function () {
        _this.onReset();
        _this.siteContainer.classList.remove('grid-container_hidden');
        _this.rootElement.classList.remove('grid-item-7_shown');
      });

      this.form.addEventListener('submit', function (e) {
        return _this.onSubmit(e);
      });
      this.name.addEventListener('focus', function (_ref) {
        var target = _ref.target;

        if (_this.nameError) {
          _this.onInputFocus(target);
          _this.nameError = false;
        }
      });

      this.tel.addEventListener('focus', function (_ref2) {
      ...
      this.email.addEventListener('focus', function (_ref3) {
    ...
    value: function onSubmit(e) {
      ...
      if (this.name.value === '') {
        ...
        var regExp = /(^[a-z'-]+([\ a-z'-])*$)|(^[а-яєіїґ'-]+([\ а-яєіїґ'-])*$)/i;
      ...
      if (this.tel.value === '') {
        ...
        var _regExp = /(^(\+|)[0-9]{11,}$)|(^(\+|)[0-9]{1,2}\([0-9]{3}\)(\-|\ |)[0-9]{3}(\-|)[0-9]{2}(\-|)[0-9]{2}$)/g;
        if (!_regExp.test(this.tel.value) && this.tel.value !== this.emptyFieldText) {
      ...
      if (this.email.value === '') {
        ...
        var _regExp2 = /[-.\w]+@([\w-]+\.)+[\w-]/gi;
        if (!_regExp2.test(this.email.value) && this.email.value !== this.emptyFieldText) {
    ...
    key: 'onError',
    value: function onError(element, errorMessage) {
      element.classList.add('form__' + element.name + '_empty');
      element.value = errorMessage;
    }
  }, {
    key: 'onInputFocus',
    value: function onInputFocus(target) {
    ...
    value: function onReset() {
      var fields = [this.name, this.tel, this.email, this.comment];
...
module.exports = "./assets/images/slide-1.png";

/***/ }),
/* 336 */
/***/ (function(module, exports) {

module.exports = "./assets/images/slide-2.png";
